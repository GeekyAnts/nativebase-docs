    ...
    <section className="relative">
      ...
      <div className="block sm:hidden">
        <div className="relative max-w-6xl mx-auto px-3 sm:px-4">
          <div className="pt-12 md:pt-20 py-10 px-3 md:py-16 md:px-12">
              ...
              <div className="max-w-3xl mx-auto text-center flex-1">
                <div className="flex flex-row mb-6 items-center">
                  ...
                  <div className="flex flex-col ml-1 text-left">
                    <p className="text-lg mb-0">NativeBase presents</p>
                    <h2 className="h2 text-2xl">Kitchen Sink</h2>
                  </div>
                </div>
                <p className="text-left mb-6">
                  Kitchen Sink is a comprehensive demo app showcasing all the
                  NativeBase UI components in action. It includes layouts,
                  forms, icons and much more.
                </p>
