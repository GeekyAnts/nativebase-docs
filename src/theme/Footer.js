        ...
        <div className="flex flex-col justify-between w-full px-6 mx-auto text-gray-500 max-w-7xl lg:px-4 md:flex-row gap-y-10">
          ...
          <div className="flex flex-col space-y-5 text-gray-500 list-none">
            ...
            <div className="flex space-x-4">
              <a href="https://www.linkedin.com/company/nativebase/about/?viewAsMember=true">
                <svg
                  className={`w-6 h-6 ${
                    isDarkTheme ? 'text-gray-200' : 'text-gray-500 '
                  }  fill-current`}
              ...
              <a href="https://www.instagram.com/nativebaseio/?hl=en">
                <svg
                  className={`w-6 h-6 ${
                    isDarkTheme ? 'text-gray-200' : 'text-gray-500 '
                  }  fill-current`}
              ...
              <a href="https://www.youtube.com/channel/UCoL_iTwpY07vDs91974z3xA/about">
                <svg
                  className={`w-6 h-6 ${
                    isDarkTheme ? 'text-gray-200' : 'text-gray-500 '
                  }  fill-current`}
