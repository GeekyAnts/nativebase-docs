...
id: installation
title: Installation
metaTitle: Installation | NativeBase
metaDescription: A guideline on how to install and set up NativeBase in your React app. Speed up your development process with NativeBase 3.0.
---
