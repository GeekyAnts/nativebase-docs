...
<div className="tailwind">
  <div className="row m-0">
    <div className="col col--9 mb-12 p-0">
      <p className="text-xl">
       NativeBase is a component library that enables devs to build universal design systems that are accessible, themeable and customizable. It is built on top of React Native, allowing you to develop apps for Android, iOS and the Web.
      </p>
