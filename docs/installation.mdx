...
**NativeBase** is supported in [Expo](https://docs.expo.io/get-started/installation/) or React Native initiated apps. Web support is made possible by [react-native-web](https://necolas.github.io/react-native-web/).
