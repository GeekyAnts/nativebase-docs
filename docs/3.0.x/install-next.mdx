...
>
  Choose your preferred template and start your development swiftly. Open a Terminal in your project's folder and run the following one of these command :
</Text>
<br />
<Text
  _dark={{ color: "coolGray.300" }}
...
#### In your Next.js project, install NativeBase by running either of the following:
