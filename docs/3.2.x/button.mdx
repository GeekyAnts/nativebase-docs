...
metaDescription: The Button component in NativeBase triggers an event or action. Learn about sizes, variants, icons, loading, ButtonGroup, and more here, along with examples.
---
