...
<Text
  ...
  fontWeight="medium"
>
  NativeBase can be used in your web project just like mobile. This is possible
  using react-native-web. You can follow the below steps to install NativeBase
  template using create-react-app.
</Text>
<br/>
<Box>
<Box 
