...
metaTitle: "Pseudo props: Overview | NativeBase"
metaDescription: NativeBase pseudo props can be used to customize the style or behaviour of Nativebase components across platforms.
---
...
import React from "react";
import { Box, HStack, Pressable, Text, VStack, useDisclose } from "native-base";
export function Example() {
  const { isOpen, onOpen, onClose } = useDisclose();
  return (
    <Center my="4">
