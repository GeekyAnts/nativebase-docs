...
(IMPORTANT INFO: NativeBase will no longer be maintained. We recommend using [gluestack-ui](https://ui.gluestack.io/) instead. [Know more](https://nativebase.io/blogs/road-ahead-with-gluestack-ui).)
