...
[Refer this link](https://github.com@3.3.2/react-native-community/cli#about) to get infomation about the React Native CLI.
...
<Center>
  <AspectRatio ratio={2.21} w="100%" maxW="500" my="2">
