...
_The following is the overview of the changelog_
...
_Added the following design changes to all components: color change, shadow, padding, and opacity changes. All changes are according to the new formats._
