...
metaTitle: Upgrading to 3.2.0 from 3.x | NativeBase
metaDescription: "In NativeBase v3.2.0 we revamped the features and theme and made them more optimized. Read on to find out how to easily upgrade to v3.2.0 with three options.
"
---
